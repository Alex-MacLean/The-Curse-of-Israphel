...
public class IsraphelMageEntity extends AbstractIsraphelEntity {

    private static final DataParameter<Byte> AI_FLAGS = EntityDataManager.createKey(IsraphelMageEntity.class, DataSerializers.BYTE);

    public IsraphelMageEntity(World worldIn) {
        super(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.illusionCastingTime <= 0 && this.getAttackTarget() != null) {
            ...
            int z = (int) this.posZ;
            if (!world.isRemote) {
                Entity entity1 = new FakeIsraphelMageEntity(world);
                Entity entity2 = new FakeIsraphelMageEntity(world);
                Entity entity3 = new FakeIsraphelMageEntity(world);
                Entity entity4 = new FakeIsraphelMageEntity(world);
        ...
        if (this.effectsCastingTime <= 0 && this.getAttackTarget() != null) {
            EntityLivingBase entity = IsraphelMageEntity.this.getAttackTarget();
            if (entity != null) {
