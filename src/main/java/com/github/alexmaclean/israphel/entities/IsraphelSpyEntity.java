...
public class IsraphelSpyEntity extends AbstractIsraphelEntity {
    public IsraphelSpyEntity(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(2, new EntityAIAvoidEntity<>(this, EntityPlayer.class, Config.IsraphelSpyObservationDistance, 0.7D, 1.0D));
    }
