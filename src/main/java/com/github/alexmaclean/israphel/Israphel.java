...
@Mod(name = Israphel.NAME, useMetadata = true, updateJSON = Israphel.UPDATEJSON,acceptedMinecraftVersions = Israphel.MCVERSION, version = Israphel.VERSION, modid = Israphel.MODID)
public class Israphel {
    public static final String NAME = "The Curse of Israphel";
    public static final String UPDATEJSON = "https://raw.githubusercontent.com/Alex-MacLean/The-Curse-of-Israphel/main/update.json";
